...
type Phase2CompatibilitySuite struct {
	suite.Suite
	server *httptest.Server
}

func TestPhase2CompatibilitySuite(t *testing.T) {
	suite.Run(t, new(Phase2CompatibilitySuite))
}

func (s *Phase2CompatibilitySuite) SetupTest() {
	s.server = httptest.NewServer(api.NewRouter(testhelper.DefaultConfig()))
}

func (s *Phase2CompatibilitySuite) TearDownTest() {
	s.server.Close()
}

func (s *Phase2CompatibilitySuite) TestCreateCoreResources() {
...
func (s *Phase2CompatibilitySuite) createImage(name string) *images.Image {
...
func (s *Phase2CompatibilitySuite) createNetwork(
	name string,
) *networks.Network {
...
func (s *Phase2CompatibilitySuite) createServer(
	name string,
	imageID string,
	networkID string,
) *servers.Server {
...
func (s *Phase2CompatibilitySuite) createVolume(name string) *volumes.Volume {
